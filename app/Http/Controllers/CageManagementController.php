...
use App\Models\Cage\Cages_eye;
use App\Models\Cage\Cages_name;
...
class CageManagementController extends Controller
{
    public function index()
    {
        ...
        $cages_eyes = Cages_eye::with(['rabbits_in_cages', 'cages_name'])->withCount('rabbits_in_cages')->paginate(25);
